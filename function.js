const translations = {
    en: {
        ...
        "job1-desc": "&bull Leading the development of over 15+ medium to high complexity toy products from concept to production, ensuring each is delivered on time, on cost, and on spec by actively managing timelines, cost, and technical feasibility.\n&bull Created and revised complex 3D models and assemblies using SolidWorks and Onshape, supporting iterative design reviews, internal CAD Checkpoints, and tooling development with internal teams and overseas manufacturers.\n&bull Applied DFMA/DFM principles to optimize injection- and blow-molded parts, reducing part complexity and achieving average cost savings of 10% per unit through material and tooling adjustments while still meeting spec.\n&bull Collaborated with Asia, North America, and Europe-based engineering, design, marketing, and quality assurance teams to resolve complex production challenges and maintain launch schedules.",
        ...
        "job2-desc": "· Collaborated with researchers and engineers to define design goals and constraints for precision sub-assemblies supporting focused ultrasound therapies.<br> · Designed, built, and tested custom plastic and metal components and clinical jigs using SolidWorks, ensuring high mechanical precision and strict compliance with MRI and clinical cleanroom environments.<br> · Utilized additive manufacturing (3D printing) and in-house machining tools to construct and iterate functional experimental prototypes quickly.<br> · Contributed technical data and design files to clinical research studies progressing toward first-in-human medical trials.",
