const translations = {
    en: {
        ...
        "job1-desc": "· Leading the development of over 15+ medium to high complexity toy products from concept to production, ensuring each is delivered on time, on cost, and on spec by actively managing timelines, cost, and technical feasibility. <br> · Created and revised complex 3D models and assemblies using SolidWorks and Onshape, supporting iterative design reviews, internal CAD Checkpoints, and tooling development with internal teams and overseas manufacturers. <br> · Applied DFMA/DFM principles to optimize injection- and blow-molded parts, reducing part complexity and achieving average cost savings of 10% per unit through material and tooling adjustments while still meeting spec. <br> · Collaborated with Asia, North America, and Europe-based engineering, design, marketing, and quality assurance teams to resolve complex production challenges and maintain launch schedules.",
